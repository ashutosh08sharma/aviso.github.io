...
(function (d) {
    ...
    d.widget("ech.multiselect", {
        options: {
            ...
            (this.headerLinkContainer = d("")).addClass("ui-helper-reset").html(function () {
                return !0 === b.header ? '<li hidden><a class="ui-multiselect-all" href="#"><span class="ui-icon ui-icon-check"></span><span style="visibility: hidden">' + b.checkAllText + '</span></a></li><hidden><a class="ui-multiselect-none" href="#"><span class="ui-icon ui-icon-closethick"></span><span style="visibility: hidden">' + b.uncheckAllText + "</span></a></>" : "string" === typeof b.header ? "<li hidden>" + b.header + "</li>" : ""
            }).append('<div class="ui-multiselect-close"><a href="#" class="ui-multiselect-close"><span class="ui-icon ui-icon-circle-close"></span></a></div>').appendTo(c);
